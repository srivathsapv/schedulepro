...
ResultSet result=Utilfunctions.executeUpdate('INSERT INTO 'subject' VALUES ' ("+Subject Code.Text.getText()","+Subject Title.Text.getText()","+Short Form.Text.getText()","+Department.Text.getText()","+Sub Credits.ComboBox.getValue()"));        // TODO add your handling code here:
